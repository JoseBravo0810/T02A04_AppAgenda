 ...
 */
/**
 * Author: Jose Bravo Castillo 
 * Created: 31 oct. 2021
 */

/* Creacion tabla Provincia */
CREATE TABLE PROVINCIA(
        ID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY, --ID numerico autogenerado | Diferente a MySQL
        CODIGO CHAR(2),
        NOMBRE VARCHAR(20) NOT NULL,
    CONSTRAINT ID_PROVINCIA_PK PRIMARY KEY(ID)
);

/* Insercion de datos en tabla provincia */
...
/* Insercion de datos en tabla persona */
